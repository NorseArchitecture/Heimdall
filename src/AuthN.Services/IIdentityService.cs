...
/// second party's personal data (spec: <c>Glitnir/docs/Platform/specs/2026-08-03-pii-primitives-identity-erasure-seam-design.md</c>
...
public interface IIdentityService
{
	...
	/// </summary>
	[OperationContract]
	Task<Outcome<PersonalDataResponse>> GetMyPersonalDataAsync(GetMyPersonalDataRequest request, CancellationToken cancellationToken = default);
	...
	/// </summary>
	[OperationContract]
	Task<Outcome<MaskedPersonalDataResponse>> GetMaskedPersonalDataAsync(GetMaskedPersonalDataRequest request, CancellationToken cancellationToken = default);
}
